...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Unwaffle.Action = factory(root.Unwaffle.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ActionNote')) {
        obj['ActionNote'] = ApiClient.convertToType(data['ActionNote'], 'String');
      }
    }
    return obj;
  }
   ...
   */
  exports.prototype['ActionDate'] = undefined;
  /**
   * @member {String} ActionNote
   */
  exports.prototype['ActionNote'] = undefined;
